Attribute VB_Name = "IterablesFirstIndex"
Option Explicit
...
Private Sub Test01_TryGetFromEmptyArray()
    ...
    Set myResult = Types.Iterable.TryGetFirstIndex(myIterable)
   
    'Assert:
    Assert.AreEqual myExpected, myResult.Status, "Status"
    Assert.AreEqual -1&, myResult.Value, "Value"
...
Private Sub Test02_TryGetFromArray()
    ...
    Dim myResultIndex As resultlong
    Dim myResult As resultlong
    
    'Act:
    Set myResult = Types.Iterable.TryGetFirstIndex(myIterable, myResultIndex)
   
    'Assert:
    Assert.AreEqual myExpectedStatus, myResult.Status
    Assert.AreEqual myExpectedIndex, myResultIndex.Value
...
Private Sub Test03_TryGetFromEmptyArrayList()
    ...
    Assert.AreEqual -1&, myResultIndex.Value
...
Private Sub Test11_GetFromEmptyArray()
    ...
    'Act:
    myResult = Types.Iterable.GetFirstIndex(myIterable)
