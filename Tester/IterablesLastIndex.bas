Attribute VB_Name = "IterablesLastIndex"
Option Explicit
...
Private Sub Test01_TryGetFromEmptyArray()
    ...
    'Act:
    Set myResult = Types.Iterable.TryGetLastIndex(myIterable)
...
Private Sub Test02_TryGetFromArray()
    ...
    'Act:
    myResult = Types.Iterable.TryGetLastIndex(myIterable, myResultIndex).Status
...
Private Sub Test11_GetFromEmptyArray()
    ...
    'Act:
    myResult = Types.Iterable.GetLastIndex(myIterable)
