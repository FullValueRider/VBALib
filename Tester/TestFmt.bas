...
'@TestModule
'@Folder("Layout")
 'This module is commented out to prevent issues whilst debugging.
 'To use testing follow instructions in the Layout module
 'and then uncomment this module
...
'    LayoutObj.InitialiseModuleLayout
'End Sub
...
Public Sub T01_ConvertFormatFieldXX0ToVbNullString_01()
    ...
    myResult = Fmt.pvConvertFormatFieldXX0ToNoString(myTest)
...
Public Sub T02_ConvertFormatFieldXXToXX1_01()
    ...
    'Act
    myResult = Fmt.pvConvertFormatFieldXXToXX1(myTest)
...
Public Sub T03_GetFieldCount_01_nl3_equals_3()
    ...
    'Act
    myResult = Fmt.pvGetRepeatCountForField("Hello {nl3} Hello", "{nl")
...
Public Sub T11_ConvertSmartSingleQUotes()
    ...
    'Arrange:
    myExpected = "Should have double quotes ‘Hello World’"
    myTest = "Should have double quotes {so}{0}{sc}"
...
'
'    'Act
'    myResult = FmtFmt(myTest, Array(1, "Hello World", True, 5.134, Array(6, 7, 8, 9)), ipparamseparator:=";;")
'
'    'Assert:
'    Assert.AreEqual myExpected, myResult
'
