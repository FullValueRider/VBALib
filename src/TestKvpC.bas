...
Private Sub Test03_Add_Pairs()
    ...
    'Act:
    myK.AddPairs SeqC(1, 2, 3), SeqC(3, "Hello", True)
...
Private Sub Test04a_GetItem()
    ...
    'Arrange:
    Dim myK As KvpC
    Set myK = KvpC.Deb.AddPairs(SeqC(1&, 2&, 3&), SeqC(3, "Hello", True))
...
Private Sub Test09_Clone()
    ...
    Dim myItemsExpected As Variant
    myItemsExpected = SeqC(3&, "Hello", True, 1&, 2&, 3&, 4&).ToArray
    
    Dim myKeysExpected As Variant
    myKeysExpected = SeqC(1&, 2&, 3&, 4&, 5&, 6&, 7&).ToArray
    ...
    Set myT = myK.AddPairs(SeqC(1&, 2&, 3&, 4&, 5&, 6&, 7&), SeqC(3&, "Hello", True, 1&, 2&, 3&, 4&)).Clone
...
Private Sub Test15a_KeyByIndex()
    ...
    'Arrange:
    Dim myK As KvpC
    Set myK = KvpC.Deb.AddPairs(SeqC(10&, 20&, 30&, 40&, 50&, 60&, 70&), SeqC(3&, "Hello", True, 1&, 2&, 3&, 4&))
