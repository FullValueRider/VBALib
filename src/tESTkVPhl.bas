...
Private Sub Test01_ObjAndName()
    ...
    myExpected = Array(True, "KvpHL", "KvpHL")
...
Private Sub Test04a_GetItem()
    ...
    'Arrange:
    Dim myK As KvpHL
    Set myK = KvpHL.Deb.AddPairs(SeqA(1&, 2&, 3&), SeqA(3, "Hello", True))
...
Private Sub Test05a_Remove()
    ...
    'Arrange:
    Dim myK As KvpHL
    Set myK = KvpHL.Deb.AddPairs(SeqA(1&, 2&, 3&, 4&, 5&, 6&, 7&), SeqA(3&, "Hello", True, 1&, 2&, 3&, 4&))
...
Private Sub Test15a_KeyByIndex()
    ...
    'Arrange:
    Dim myK As KvpHL
    Set myK = KvpHL.Deb.AddPairs(SeqA(10&, 20&, 30&, 40&, 50&, 60&, 70&), SeqA(3&, "Hello", True, 1&, 2&, 3&, 4&))
