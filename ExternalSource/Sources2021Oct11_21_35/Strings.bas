...
Public Function ToSubStrLyst(ByVal ipString As String, Optional ByVal ipSeparator As String = Char.comma, Optional ipDeleteChars As String = Whitespace) As Lyst
...
Public Function Replacer(ByVal ipString As String, Optional ByVal ipReplaceChars As String = whitespace) As String
    ...
    For myIndex = 1 To Len(ipReplaceChars)
        ...
        ipString = VBA.Replace(ipString, VBA.Mid$(ipReplaceChars, myIndex, 1), vbNullString)
