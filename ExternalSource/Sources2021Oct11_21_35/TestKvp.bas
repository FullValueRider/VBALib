Attribute VB_Name = "TestKvp"
    ...
    Public Sub KvpTests()
        ...
        myPlace = CurrentSourceFile & Char.Colon & CurrentComponentName & Char.Period
...
#Region "NewKvp"
    ...
    Public Sub Test02_NewKvpIsKvp()
        ...
        'Assert:
        Assert.Exact.AreEqual myExpected, myResult, myPlace & CurrentProcedureName & ":AddTable"
    ...
    Public Sub Test01_pvAddOrInsertIterableIterable_ByAdd()
        ...
        For Each myKeys In myExpectedKeys
            ...
            For Each myItems In myExpectedItems
                ...
                'Assert:
                Assert.Exact.SequenceEquals myBaseKeys, myResult, TypeName(myKeys) & Char.Space & myPlace & CurrentProcedureName & ":Keys"
                Assert.Exact.SequenceEquals myBaseItems, myResultItems, TypeName(myItems) & Char.Space & myPlace & CurrentProcedureName & ":Items"
    ...
    Public Sub Test02_pvAddOrInsertIterableIterable_ByInsert()
        ...
        For Each myKeys In myTestKeys
            ...
            For Each myItems In myTestItems
                ...
                'Assert:
                Assert.Exact.SequenceEquals myExpectedKeys, myResult, TypeName(myKeys) & Char.Space & myPlace & CurrentProcedureName & ":Keys"
                Assert.Exact.SequenceEquals myExpectedItems, myResultItems, TypeName(myItems) & Char.Space & myPlace & CurrentProcedureName & ":Items"
...
#Region "Queue"
    ...
    Private Sub Test01_Enqueue_DefaultLongKey()
        ...
        'Assert:
        Assert.Exact.SequenceEquals myResult, myExpectedKeys, CurrentProcedureName
        Assert.Exact.SequenceEquals myResultValues, myExpectedValues, CurrentProcedureName
    ...
    Private Sub Test07_Dequeue_DefaultLongKey()
        ...
        'Assert:
        Assert.Exact.AreEqual myExpected, myResult.GetFirst.ToString, CurrentProcedureName
...
#Region "FilterByKeys"
    ...
    Private Sub Test01_FilterByKeys()
        ...
        'Assert:
        Assert.Exact.SequenceEquals myKeysInAandB, myAandB, CurrentProcedureName
        Assert.Exact.SequenceEquals myKeysInBonly, myB, CurrentProcedureName
        Assert.Exact.SequenceEquals myKeysInAOnly, myA, CurrentProcedureName
...
#Region "HoldsKey"
    ...
    Private Sub Test01_HoldsKey_NumberKeyIsPresent()
        ...
        'Assert:
        Assert.Exact.IsTrue myResult, CurrentProcedureName
    ...
    Private Sub Test02_HoldsKey_NumberKeyIsMissing()
        ...
        'Assert:
        Assert.Exact.IsFalse myResult, CurrentProcedureName
...
#Region "IntMinMax"
    ...
    Private Sub Test01_IntMinMax_DefaultKeys()
        ...
        'Assert:
        Assert.Exact.SequenceEquals myExpectedMinKeys, myResult.Item(0&).GetKeys.ToArray, CurrentProcedureName
        Assert.Exact.SequenceEquals myExpectedMaxKeys, myResult.Item(1&).GetKeys.ToArray, CurrentProcedureName
...
#Region "KeysAllAandOnlyB"
    ...
    Private Sub Test01_KeysAllAandOnlyB_DefaultKeysLongKey()
        ...
        'Assert:
        Assert.Exact.SequenceEquals myExpected, myResult.GetKeys.ToArray, CurrentProcedureName
...
#Region "LacksItem"
    ...
    Private Sub Test03_LacksItem_StringKeyValueIsPresent()
        ...
        'Assert:
        Assert.Exact.AreEqual False, myResult, CurrentProcedureName
    ...
    Private Sub Test06_LacksItem_ArrayKeyValueIsMissing()
        ...
        'Assert:
        Assert.Exact.AreEqual True, myResult, CurrentProcedureName
...
#Region "MirrorByFirstItem"
    ...
    Private Sub Test01_MirrorByFirstItem_DefaultKey_DefaultIntegerByIndex()
        ...
        'Assert:
        Assert.Exact.SequenceEquals myExpected, myResult.Item(0&).GetKeys.ToArray, CurrentProcedureName
...
#Region "NextPair"
    ...
    Private Sub Test01_NextPair_DefaultNoSpecifiedKey()
        ...
        'Assert:
        Assert.Exact.AreEqual myExpected.ToString, myResult.ToString, CurrentProcedureName
    TestExit:
        Exit Sub
    TestFail:
        Debug.Print myPlace & CurrentProcedureName & " raised an error: #" & Err.Number & " - " & Err.Description
...
#Region "Pull"
    ...
    Private Sub Test01_Pull_DefaultKeys()
        ...
        'Assert:
        Assert.Exact.SequenceEquals myExpectedKeys, myKvp.GetKeys.ToArray, CurrentProcedureName
        Assert.Exact.AreEqual myExpectedPair.ToString, myResult.ToString, CurrentProcedureName
        Exit Sub
...
#Region "RemoveAt"
    ...
    Private Sub Test01_RemoveAt_DefaultKeys()
        ...
        'Assert:
        Assert.Exact.SequenceEquals myExpectedKeys, myResult, CurrentProcedureName
        Exit Sub
...
Private Sub Test01_SumKeys_IsObject()
    ...
    'Assert:
    'Assert.Exact.IsTrue IsObject(myKvp)
